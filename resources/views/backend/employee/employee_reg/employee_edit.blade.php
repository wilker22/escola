            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Editar Funcionário </h4>
                                                        ...
                                                        <div class="controls">
                                                            <select name="gender" id="gender" required=""
                                                                ...
                                                                <option value="" selected="" disabled="">Select
                                                                    Gender</option>
                                                                <option value="Male"
                                                                    {{ $editData->gender == 'Masculino' ? 'selected' : '' }}>Masculino
                                                                </option>
                                                                <option value="Female"
                                                                    {{ $editData->gender == 'Feminino' ? 'selected' : '' }}>
                                                                    Feminino</option>
                                                        ...
                                                        <div class="controls">
                                                            <select name="religion" id="religion" required=""
                                                                ...
                                                                <option value="Christan"
                                                                    {{ $editData->religion == 'Cristã' ? 'selected' : '' }}>
                                                                    Cristã</option>
