            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Editar Registro de Comparecimento </h4>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                                    ...
                                                    <table class="table table-bordered table-striped" style="width: 100%">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th rowspan="2" class="text-center"
                                                                    style="vertical-align: middle;">Funcionários</th>
                                                                <th colspan="3" class="text-center"
                                                                    style="vertical-align: middle; width: 30%">Status de Comparecimento</th>
                                                            </tr>
                                                                ...
                                                                <tr id="div{{ $data->id }}" class="text-center">
                                                                    ...
                                                                    <td colspan="3">
                                                                        <div class="switch-toggle switch-3 switch-candy">
                                                                            ...
                                                                            <label
                                                                                for="present{{ $key }}">Presente</label>
                                            ...
                                            <div class="text-xs-right">
                                                <input type="submit" class="btn btn-rounded btn-info mb-5" value="Atualizar">
                                            </div>
                                </form>
