                    ...
                    <div class="col-12">
                        <div class="box bb-3 border-warning">
                            <div class="box-header">
                                <h4 class="box-title">Relatórios -  <strong>Boletim</strong></h4>
                            </div>
                            ...
                            <div class="box-body" style="border: solid 1px; padding: 10px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center" style="float: left;">
                                        <h4><strong>WTech - Sistema Escolar</strong></h4>
                                        <h6><strong>Petrolina - PE</strong></h6>
                                        <h5><strong><u><i>Boletim Acadêmico</i></u></strong></h5>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p style="text-align: right;"><u><i>Data: </i>{{ date('d M Y') }} </u></p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="8"
                                            ...
                                            <tr>
                                                <td width="50%">Aluno Id</td>
                                                <td width="50%">{{ $allMarks['0']['id_no'] }}</td>
                                            </tr>

                                            <tr>
                                                <td width="50%">Lista No</td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1"
                                            ...
                                            @endphp
                                            <tr>
                                                <td width="50%"><strong>Média</strong></td>
                                                <td width="50%">
                                                    @if ($count_fail > 0)
                                                        0.00
                                                    @else
                                            ...
                                            <tr>
                                                <td width="50%"><strong>Letra </strong></td>
                                                <td width="50%">
                                                    @if ($count_fail > 0)
                                                        F
                                                    @else
                                            ...
                                            <tr>
                                                <td width="50%">Notas Totais - Fração</td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="text-align: left;"><strong>Observações:</strong>
                                                        @if ($count_fail > 0)
                                                            Fail
                                                        @else
                                                            {{ $total_grade->remarks }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
                                        <div class="text-center">Responsáveis </div>
                                    </div>

                                    <div class="col-md-4">
                                        <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
                                        <div class="text-center">Diretor</div>
                                    </div>
